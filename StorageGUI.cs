...
namespace MagicStorage
{
	public static class StorageGUI
	{
		...
		private static void InitSortButtons()
		{
			if (sortButtons == null)
			{
				//Give me the textures now b/c they won't load properly for some reason if I don't do this
				sortButtons = new UIButtonChoice(new Texture2D[]
				{
					...
					MagicStorage.Instance.Assets.Request<Texture2D>("SortNumber", AssetRequestMode.ImmediateLoad).Value
				},
				new LocalizedText[]
				{
