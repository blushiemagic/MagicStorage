...
namespace MagicStorage.Items
{
	public class SnowBiomeEmulator : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation(GameCulture.Russian, "Эмулятор Снежного Биома");
			...
			Tooltip.AddTranslation(GameCulture.Russian, "Позволяет создавать рецепты снежного биома в Интерфейсе Крафтинга");
