...
namespace MagicStorage.Items
{
	public class UpgradeHellstone : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation(GameCulture.Russian, "Адский Апгрейд Ячейки");
			...
			Tooltip.AddTranslation(GameCulture.Russian, "Улучшает Ячейку до 120 слотов"
				+ "\nИспользуйте <right> на Демонитовой/Кримтановой ячейке для применения");
