...
namespace MagicStorage {
	public class MagicStorageConfig : ModConfig
	{
		...
		[Header($"$Mods.MagicStorage.Config.Headers.Debugging")]
		[DefaultValue(false)]
		public bool printTextToChat;

		[DefaultValue(true)]
		public bool showPylonAreasOnMap;

		[DefaultValue(false)]
		public bool showPylonAreasInWorld;
		...
		[JsonIgnore]
		public static bool PrintDebuggingTextToChat => Instance.printTextToChat;

		[JsonIgnore]
		public static bool ShowPylonAccessAreasOnMap => Instance.showPylonAreasOnMap;

		[JsonIgnore]
		public static bool ShowPylonAccessAreasInWorld => Instance.showPylonAreasInWorld;
	...
	/// </summary>
	[Obsolete("Config members have been moved to MagicStorageConfig", error: true)]
